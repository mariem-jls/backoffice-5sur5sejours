 ...
 * BoltBlocks
 *
 * @ORM\Table(name="bolt_blocks", indexes={@ORM\Index(name="IDX_7B2C81B7989D9B62", columns={"slug"}), @ORM\Index(name="IDX_7B2C81B7BE74E59A", columns={"datechanged"}), @ORM\Index(name="IDX_7B2C81B7B7805520", columns={"datedepublish"}), @ORM\Index(name="IDX_7B2C81B7AFBA6FD8", columns={"datecreated"}), @ORM\Index(name="IDX_7B2C81B7A5131421", columns={"datepublish"}), @ORM\Index(name="IDX_7B2C81B77B00651C", columns={"status"})})
 * @ORM\Entity
 */
class BoltBlocks
{
